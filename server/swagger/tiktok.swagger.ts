    ...
    "/api/v1/tiktok/publish": {
      post: {
              ...
              schema: {
                ...
                properties: {
                  ...
                  caption: {
                    ...
                    example: "Video hướng dẫn sử dụng iGen Marketing thông minh #igen #erp",
                  },
                  videoUrl: {
                    type: "string",
                    description:
                  ...
                  blotatoApiKey: {
                    type: "string",
                    description: "API Key Blotato của bạn. Nếu không truyền, hệ thống sẽ sử dụng BLOTATO_API_KEY từ .env.",
        ...
        responses: {
          200: {
            description:
              "Gọi yêu cầu đăng video thành công hoặc đang xử lý",
            content: {
              "application/json": {
                schema: {
                  type: "object",
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  blotatoApiKey: {
                    type: "string",
                    description: "API Key Blotato để xác thực tài khoản. Nếu không truyền, hệ thống sẽ sử dụng BLOTATO_API_KEY từ .env.",
                    example: "blotato_api_...",
                  },
                },
              },
        ...
        parameters: [
          {
            name: "blotatoApiKey",
            in: "query",
            description: "API Key Blotato. Nếu không truyền, hệ thống sẽ sử dụng BLOTATO_API_KEY từ .env.",
            required: false,
            schema: { type: "string" },
          },
        ],
