...
const CampaignAssetOrderSchema = new Schema<ICampaignAssetOrder>(
  {
    ...
    contentGroup: { type: String, default: "", maxlength: 240 },
    shootingContent: { type: String, default: "", maxlength: 1000 },
    productionRequirements: { type: String, default: "", maxlength: 2000 },
    quantitySuggestion: { type: String, default: "", maxlength: 120 },
    usageChannels: { type: String, default: "Facebook", maxlength: 500 },
